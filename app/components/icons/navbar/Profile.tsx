    ...
    return (
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="32" viewBox="0 0 20 38" fill="none">
                ...
                <path d="M10.2026 13.624C13.1364 13.624 15.5147 11.2458 15.5147 8.31203C15.5147 5.37828 13.1364 3 10.2026 3C7.2689 3 4.89062 5.37828 4.89062 8.31203C4.89062 11.2458 7.2689 13.624 10.2026 13.624Z" opacity={props.active ? "100%" : "40%"} stroke="black" stroke-width="4.5" stroke-miterlimit="10" />
            </svg>
        </div>
    );
}
