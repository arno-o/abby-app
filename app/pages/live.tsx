...
const Live = () => {
    ...
    return (
        <>
        <div className="absolute z-5 h-screen w-screen" onClick={() => setMenu(true)} id="bg"></div>
            ...
            <div className="">
                ...
                <div className={`${menu ? '' : 'hidden'}`}>
                    <div className="flex flex-col justify-between">
                        <div className="z-6 absolute mt-4 p-5 w-screen text-white">
                    ...
                    <div className="fixed z-6 flex justify-between bg-stone-300 m-4 bottom-32 w-[93%]" id="selectionMenu">
                    ...
                    <div onClick={() => setMenu(false)} className="absolute z-4 bg-black h-screen w-screen opacity-50" id="bg"></div>
